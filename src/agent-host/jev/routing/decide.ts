import type { JevAnswer, JevQuestions } from "../../vendor/jev/index";
import type { JevRoutingSettings } from "../settings";
 ...
 */
export function decideRouting(answers: Record<string, JevAnswer>, config: JevRoutingSettings): RoutingDecision {
